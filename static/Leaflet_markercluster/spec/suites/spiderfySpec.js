describe('spiderfy', function () {
	...
	it('adds then removes class "leaflet_lib-cluster-anim" from mapPane on spiderfy', function () {
		...
		expect(map._panes.mapPane.className).to.contain('leaflet_lib-cluster-anim');

		clock.tick(1000);

		expect(map._panes.mapPane.className).to.not.contain('leaflet_lib-cluster-anim');

	});

	it('adds then removes class "leaflet_lib-cluster-anim" from mapPane on unspiderfy', function () {
	...
	it('does not leave class "leaflet_lib-cluster-anim" on mapPane when group is removed while spiderfied', function () {

(function (factory, window) {
    // define an AMD module that relies on 'leaflet_lib'
    if (typeof define === 'function' && define.amd) {
        define(['leaflet_lib','spin.js'], function (L, Spinner) {
            factory(L, Spinner);
        });

    // define a Common JS module that relies on 'leaflet_lib'
    } else if (typeof exports === 'object') {
        module.exports = function (L, Spinner) {
            if (L === undefined) {
                L = require('leaflet_lib');
            }

...
_forms_js = ['leaflet_lib/draw/leaflet_lib.draw.js',
             'leaflet_lib/leaflet_lib.extras.js',
             'leaflet_lib/leaflet_lib.forms.js']
if SRID:
    _forms_js += ['leaflet_lib/proj4.js',
                  'leaflet_lib/proj4leaflet.js',
                  'proj4js/%s.js' % SRID]

_forms_css = ['leaflet_lib/draw/leaflet_lib.draw.css']
...
if app_settings.get('MINIMAP'):
    PLUGINS['minimap'] = {
        'css': 'leaflet_lib/Control.MiniMap.css',
        'js': 'leaflet_lib/Control.MiniMap.js',
        'auto-include': True
    }

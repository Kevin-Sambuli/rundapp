L.Control.ResetView = L.Control.extend({
    ...
    onAdd: function (map) {
        ...
        var container = L.DomUtil.create('div', 'leaflet_lib-control-zoom leaflet_lib-bar');
        var link = L.DomUtil.create('a', 'leaflet_lib-control-zoom-out leaflet_lib-bar-part', container);
        link.href = '#';
    ...
    _djAddLayers: function () {
        ...
        function l2d(l) {
            ...
            if (typeof l[2] === 'string') {
                // remain compatible with django-leaflet_lib <= 0.15.0
...
L.Map.djangoMap = function (id, options) {
    ...
    if (options.callback === null) {
        /*
         * Deprecate django-leaflet_lib < 0.7 default callback
         */
